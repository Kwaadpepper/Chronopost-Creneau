...
class Search extends AbstractSoapClientBase
{
     ...
     * @param \StructType\SearchDeliverySlot $parameters
     * @return \StructType\SearchDeliverySlotResponse|bool
     */
    public function searchDeliverySlot(\StructType\SearchDeliverySlot $parameters)
    {
        try {
