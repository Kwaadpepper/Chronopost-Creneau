...
/**
 * This class stands for confirmDeliverySlot StructType
 * Meta information extracted from the WSDL
 * - type: tns:confirmDeliverySlot
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ConfirmDeliverySlot extends AbstractStructBase
{
    /**
     * The callerTool
     * Meta information extracted from the WSDL
     ...
     * @uses ConfirmDeliverySlot::setCallerTool()
     * @uses ConfirmDeliverySlot::setProductType()
     * @uses ConfirmDeliverySlot::setCodeSlot()
     * @uses ConfirmDeliverySlot::setMeshCode()
     * @uses ConfirmDeliverySlot::setTransactionID()
     * @uses ConfirmDeliverySlot::setRank()
     * @uses ConfirmDeliverySlot::setPosition()
     * @uses ConfirmDeliverySlot::setDateSelected()
     ...
     * @param string $callerTool
     * @return \ChronopostTimeSlot\StructType\ConfirmDeliverySlot
     */
