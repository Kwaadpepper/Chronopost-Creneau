...
/**
 * This class stands for getAdresseGeocodage StructType
 * Meta information extracted from the WSDL
 * - type: tns:getAdresseGeocodage
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class GetAdresseGeocodage extends AbstractStructBase
{
    /**
     * The adresse1
     * Meta information extracted from the WSDL
     ...
     * @uses GetAdresseGeocodage::setAdresse1()
     * @uses GetAdresseGeocodage::setAdresse2()
     * @uses GetAdresseGeocodage::setZipCode()
     * @uses GetAdresseGeocodage::setCity()
     ...
     * Set adresse1 value
     * @param string $adresse1
     * @return \ChronopostTimeSlot\StructType\GetAdresseGeocodage
     */
