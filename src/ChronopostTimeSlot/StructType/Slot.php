...
/**
 * This class stands for slot StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class Slot extends AbstractStructBase
{
    /**
     ...
     * @uses Slot::setDeliverySlotCode()
     * @uses Slot::setDeliveryDate()
     * @uses Slot::setDayOfWeek()
     * @uses Slot::setStartHour()
     * @uses Slot::setStartMinutes()
     * @uses Slot::setEndHour()
     * @uses Slot::setEndMinutes()
     * @uses Slot::setTariffLevel()
     * @uses Slot::setStatus()
     * @uses Slot::setCodeStatus()
     * @uses Slot::setNote()
     * @uses Slot::setIncentiveFlag()
     * @uses Slot::setRawRank()
     * @uses Slot::setRank()
