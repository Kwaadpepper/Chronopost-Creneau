...
/**
 * This class stands for searchDeliverySlot StructType
 * Meta information extracted from the WSDL
 * - type: tns:searchDeliverySlot
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SearchDeliverySlot extends AbstractStructBase
{
    /**
     * The callerTool
     * Meta information extracted from the WSDL
     ...
     * @uses SearchDeliverySlot::setCallerTool()
     * @uses SearchDeliverySlot::setProductType()
     * @uses SearchDeliverySlot::setShipperAdress1()
     * @uses SearchDeliverySlot::setShipperAdress2()
     * @uses SearchDeliverySlot::setShipperZipCode()
     * @uses SearchDeliverySlot::setShipperCity()
     * @uses SearchDeliverySlot::setShipperCountry()
     * @uses SearchDeliverySlot::setRecipientAdress1()
     * @uses SearchDeliverySlot::setRecipientAdress2()
     * @uses SearchDeliverySlot::setRecipientZipCode()
     * @uses SearchDeliverySlot::setRecipientCity()
     * @uses SearchDeliverySlot::setRecipientCountry()
     * @uses SearchDeliverySlot::setInjectionSite()
     * @uses SearchDeliverySlot::setWeight()
     * @uses SearchDeliverySlot::setDateBegin()
     * @uses SearchDeliverySlot::setDateEnd()
     * @uses SearchDeliverySlot::setShipperDeliverySlotClosed()
     * @uses SearchDeliverySlot::setCurrency()
     * @uses SearchDeliverySlot::setRateN1()
     * @uses SearchDeliverySlot::setRateN2()
     * @uses SearchDeliverySlot::setRateN3()
     * @uses SearchDeliverySlot::setRateN4()
     * @uses SearchDeliverySlot::setRateLevelsNotShow()
     * @uses SearchDeliverySlot::setIsDeliveryDate()
     * @uses SearchDeliverySlot::setSlotType()
     ...
     * @param string $callerTool
     * @return \ChronopostTimeSlot\StructType\SearchDeliverySlot
     */
    ...
    /**
     * This method is responsible for validating the value(s) passed to the setShipperDeliverySlotClosed method
     ...
     */
    public static function validateShipperDeliverySlotClosedForArrayConstraintFromSetShipperDeliverySlotClosed(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
    ...
    public function setShipperDeliverySlotClosed(?array $shipperDeliverySlotClosed = null): self
    {
        ...
        if ('' !== ($shipperDeliverySlotClosedArrayErrorMessage = self::validateShipperDeliverySlotClosedForArrayConstraintFromSetShipperDeliverySlotClosed($shipperDeliverySlotClosed))) {
    ...
    /**
     * This method is responsible for validating the value(s) passed to the setRateLevelsNotShow method
     ...
     * @return string A non-empty message if the values does not match the validation rules
     */
    public static function validateRateLevelsNotShowForArrayConstraintFromSetRateLevelsNotShow(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
    ...
    {
        // validation for constraint: array
        if ('' !== ($rateLevelsNotShowArrayErrorMessage = self::validateRateLevelsNotShowForArrayConstraintFromSetRateLevelsNotShow($rateLevelsNotShow))) {
