...
/**
 * This class stands for confirmDeliverySlotV2 StructType
 * Meta information extracted from the WSDL
 * - type: tns:confirmDeliverySlotV2
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ConfirmDeliverySlotV2 extends AbstractStructBase
{
    /**
     * The callerTool
     * Meta information extracted from the WSDL
     ...
     * @uses ConfirmDeliverySlotV2::setCallerTool()
     * @uses ConfirmDeliverySlotV2::setProductType()
     * @uses ConfirmDeliverySlotV2::setCodeSlot()
     * @uses ConfirmDeliverySlotV2::setMeshCode()
     * @uses ConfirmDeliverySlotV2::setTransactionID()
     * @uses ConfirmDeliverySlotV2::setRank()
     * @uses ConfirmDeliverySlotV2::setPosition()
     * @uses ConfirmDeliverySlotV2::setDateSelected()
     ...
     * @param string $callerTool
     * @return \ChronopostTimeSlot\StructType\ConfirmDeliverySlotV2
     */
