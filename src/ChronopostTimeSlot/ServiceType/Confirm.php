...
class Confirm extends AbstractSoapClientBase
{
     ...
     * @return \ChronopostTimeSlot\ServiceType\Confirm
     */
     ...
     * @param \ChronopostTimeSlot\StructType\ConfirmDeliverySlotV2 $parameters
     * @return \ChronopostTimeSlot\StructType\ConfirmDeliverySlotV2Response|bool
     */
    public function confirmDeliverySlotV2(\ChronopostTimeSlot\StructType\ConfirmDeliverySlotV2 $parameters)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::setResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \ChronopostTimeSlot\StructType\ConfirmDeliverySlot $parameters
     * @return \ChronopostTimeSlot\StructType\ConfirmDeliverySlotResponse|bool
     */
    public function confirmDeliverySlot(\ChronopostTimeSlot\StructType\ConfirmDeliverySlot $parameters)
    {
        try {
     ...
     * @return \ChronopostTimeSlot\StructType\ConfirmDeliverySlotResponse|\ChronopostTimeSlot\StructType\ConfirmDeliverySlotV2Response
     */
